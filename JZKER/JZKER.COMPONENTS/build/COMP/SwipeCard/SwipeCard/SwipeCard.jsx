...
import style from "./SwipeCard.scss"
...
export default class SwipeCard extends React.PureComponent {
	render(){
		return (
		<div className={style["SwipeCard"]} ref="SwipeCardShell">
			<div className={style["SwipeCard-content"]} ref="content" style={this.ComputedStyle.content}>
				{this.ContentComponent}
			</div>
			<div className={style["SwipeCard-ButtonGroup"]} ref="ButtonGroup" >
