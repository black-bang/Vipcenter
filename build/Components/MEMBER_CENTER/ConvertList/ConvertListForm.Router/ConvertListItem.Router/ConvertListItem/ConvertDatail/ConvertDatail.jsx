...
class ConvertDatail extends React.Component {
  render() {
    return <div className="ConvertDatail">
        {/* 优惠券信息 */}
        <div className="datail_top">
          <div className="inform_box" style={{ backgroundImage: `url(${Bg})` }}>
            ...
            <div className="card_pic">
              <div className="top">
                <div className="Qrcard" style={{ backgroundImage: `url(${"http://" + this.state.data.QrCode})` }} />
              </div>
  ...
  async componentDidMount() {
    ...
    try{
      ...
      let Cnumbers = result.OrderNo.replace(
        /(^\d{4}|\d{4}\B)/g,
        "$1 "
      );
      this.setState({ Cnumber: Cnumbers });
